...
export class PacienteService {
  ...
  update(paciente: IPaciente): Observable<EntityResponseType> {
    return this.http.put<IPaciente>(`${this.resourceUrl}/${getPacienteIdentifier(paciente) as string}`, paciente, { observe: 'response' });
  }

  partialUpdate(paciente: IPaciente): Observable<EntityResponseType> {
    return this.http.patch<IPaciente>(`${this.resourceUrl}/${getPacienteIdentifier(paciente) as string}`, paciente, {
      observe: 'response',
    });
  }
