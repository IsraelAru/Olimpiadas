...
describe('Component Tests', () => {
  describe('Diario Management Component', () => {
    let comp: DiarioComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(DiarioComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.diarios?.[0]).toEqual(jasmine.objectContaining({ id: 'ABC' }));
    });
