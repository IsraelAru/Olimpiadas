...
export class Config {
    debugLogging = 'debug';
    'server.port' = '8081';
    'jhipster.clientApp.name' = 'Diafragma';
    ...
    'jhipster.mail.from' = 'Diafragma@localhost';
    'jhipster.swagger.default-include-pattern' = '/api/.*';
    'jhipster.swagger.title' = 'Diafragma API';
    'jhipster.swagger.description' = 'Diafragma API documentation';
    ...
    'eureka.instance.appname' = 'Diafragma';
    'eureka.instance.instanceId' = 'Diafragma:${random.value}';
